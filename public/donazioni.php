          ...
          <div class="col-md-6 chart-subrow">
            <div class="row chart-subrow-row">
              <div class="col-md-12 subrow-title-container">
                <div class="subrow-title">RICEVENTI</div>
              </div>
              ...
              <div class="container">
                <div class="row">
                  <div class="col-md-6 details-left">
                    ...
                    <div class="details-line"><span class="details-line-title">Istituzione:</span> </div>
                    <div class="details-line"><span class="details-line-title">Ruolo istituzionale:</span> </div>
